# Who's your Daddy? program V2
#
# Lets the user enter the name of a male and produces the name of his father.
# ADDED: Lets the user enter a name and get back his grandfather.
...
while choice != "0":
    ...
    5 - Look up a Son-Grandfather pair
    """
    ...
    # get a son-grandfather pair
    elif choice == "5":
        son = input("Who do you want me to look up for who their grandfather is?: ")
        if son in sonFather:
            pair = sonFather[son]
            if pair in sonFather:
                grandfather = sonFather[pair]
                print("\n",son,"grandfather is", grandfather)
            else:
                print("\nSorry, I don't know", son)
        else:
            print("\nSorry, I don't know", son)
